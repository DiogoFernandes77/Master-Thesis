                    ...
                    for name in filename:
                        ...
                        with open(sample_dir + '/' + name, "r") as f:
                            ...
                            for row_raw in csv_file:
                                ...
                                if (row[0] == 'V' and row[2] == '4' and row[3] == '1'): #procura pelo grafico de vibração para a 4 mudança, aceleração
                                    for x in row[8:] : # vai so escrever no ficheiro apenas os valores, retira labels
                                        sample.append(float(x))
                                elif(row[0] == 'F' and row[2] == '4' and row[3] == '1' and (row[4] == '105' or row[4] == '106' or row[4] == '107')):
